				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="card-body">
							...
							<div class="form-group row row-disabled">
								<label for="no_plat" class="col-md-4 col-form-label form-control-label">No. HP</label>
								<div class="col-md-8">
									<input class="form-control" name="no_plat" type="text" id="no_plat" placeholder="Masukkan Nomor HP">
								</div>
							</div>
							</form>
						...
						<form role="form" action="#" method="POST" id="addProductForm">
							...
							<div class="card bg-gradient-primary border-0 text-center mb-4">
								<div class="card-body">
									<div class='row'>
											...
											<div class="form-group mb-3">
												<div class="input-group input-group-merge input-group-alternative">
													<div class="input-group-prepend">
														<span class="input-group-text"><i class="ni ni-box-2">ID Nota</i></span>
													</div>
										...
										<div class="col-md-6">
											<div class="form-group mb-3">
												<div class="input-group input-group-merge input-group-alternative">
													<div class="input-group-prepend">
														<span class="input-group-text"><i class="ni ni-box-2">Stok</i></span>
													</div>
													<input name="stok" class="form-control add-stok" placeholder="Stok Barang" type="text">
												</div>
											</div>
										</div>
									</div>
									<div class="form-group mb-3">
										<div class="input-group input-group-merge input-group-alternative">
											<div class="input-group-prepend">
												<span class="input-group-text"><i class="ni ni-box-2">Nama Barang</i></span>
											</div>
											<input name="nama" class="form-control add-namabarang" placeholder="Nama Barang" type="text" >
										</div>
									</div>
									<div class="row">
										<div class="col-md-6">
											<div class="form-group mb-3">
												<div class="input-group input-group-merge input-group-alternative">
													<div class="input-group-prepend">
														<span class="input-group-text"><i class="ni ni-box-2">Harga Beli</i></span>
													</div>
													<input name="hargadasar" class="form-control add-hargadasar" placeholder="Harga Dasar Barang" type="text">
												</div>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group mb-3">
												<div class="input-group input-group-merge input-group-alternative">
													<div class="input-group-prepend">
														<span class="input-group-text"><i class="ni ni-box-2">Harga Jual</i></span>
													</div>
													<input name="hargajual" class="form-control add-hargajual" placeholder="Harga Jual Barang" type="text" >
												</div>
											</div>
										</div>
									</div>
							...
							<div class="form-group mb-3">
								<div class="input-group input-group-merge input-group-alternative input-data-barang">
									<div class="input-group-prepend">
										<span class="input-group-text"><i class="ni ni-box-2">Qty Barang</i></span>
									</div>
							...
							<div class="form-group mb-3">
								<div class="input-group input-group-merge input-group-alternative input-data-barang">
									<div class="input-group-prepend">
										<span class="input-group-text"><i class="ni ni-box-2">Diskon</i></span>
									</div>
