...
class Products extends CI_Controller
{
    ...
    if ($jenis_harga == 'harga_dasar') {
        ...
        $response = array('code' => 201, 'message' => 'Harga dasar berhasil diperbarui');
    } else if ($jenis_harga == 'harga_jual') {
        $harga_dasar = $this->product->get_hargadasar($id_brg);
        if ($val < $harga_dasar) {
            $response = array('code' => 400, 'message' => 'Harga jual tidak boleh lebih rendah dari harga dasar');
        } else {
            $this->product->update_hargajual($id_brg, $val);
            $response = array('code' => 201, 'message' => 'Harga jual berhasil diperbarui');
        }
    }
