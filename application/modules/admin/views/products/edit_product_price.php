					...
					},
					{
						"mRender": function(data, type, row) {
							...
							return "<a href='#/' class='harga harga_jual d-inline' >" + row.brg_hargajual + "</a>" +
								...
								'<div class="editable-input parent_ubah_harga" style="position: relative;">' +
								'<form class="form-ubah-barang"><input name="harga_jual" type="number" data-type="text" data-id="' + row.brg_id + '" data-name="harga_jual"  class="form-control input-sm ubah_harga_jual" style="padding-right: 24px;" value="' + row.brg_hargajual + '" min="' + row.brg_hargadasar + '" oninvalid="this.setCustomValidity(\''+alert+'\')" oninput="setCustomValidity(\'\')"></form>' +
								'</div>' +
								'<div class="editable-error-block help-block" style="display: none;"></div>' +
