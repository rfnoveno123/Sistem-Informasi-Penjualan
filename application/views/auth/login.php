...
<html lang="id-ID">
  ...
  <div class="d-lg-flex half">
    <div class="bg order-1 order-md-2" style="background-image: url(<?php echo get_theme_uri('custom/auth/login/images/bgparfum.webp'); ?>);"></div>
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-7">
            ...
            <p class="mb-4">Sistem Informasi Penjualan & Manajemen Stok <strong><?php echo get_store_name(); ?></strong></p>
